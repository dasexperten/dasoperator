...
import emailCorrespondentsRoutes from './routes/email-correspondents';
...
app.route('/api/email', emailCorrespondentsRoutes); // adds GET /correspondents
...
app.route('/api/cron-runs', cronRunsRoutes);
