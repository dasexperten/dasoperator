 ...
 * Лента витрины версии 3 отдаёт их в delivery_chunks[].items[]. Старые строки
 * зеркала могут содержать только quantity, поэтому отсутствие SKU или имени
 * остаётся допустимым и ничего не выдумывается.
 *
 * Ожидаем позицию такой формы:
