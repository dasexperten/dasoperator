...
const checks = [
  ...
  [api.includes("cacheKey('ga4:commerce-losses:v24'") && api.includes("host: 'com'"), 'commerce cache key exposes distinct-user measurement immediately'],
  ...
  [api.includes("cacheKey('ga4:commerce-losses:v25'"), 'commerce cache invalidates for the checkout CTA schema'],
