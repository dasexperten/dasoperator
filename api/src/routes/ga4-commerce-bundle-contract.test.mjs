...
const checks = [
  ...
  [api.includes("cacheKey('ga4:commerce-losses:v35'") && api.includes("host: 'com'"), 'commerce cache key exposes conservative suppressed-minute attribution immediately'],
  ...
  [api.includes("{ name: 'date' },") && api.includes("suppressed_minute_policy: 'complete_property_dates_only'") && api.includes('row.event_date > priceTestStartDate && row.event_date < priceTestEndDate'), 'privacy-suppressed minutes use only complete property-calendar days inside the approved seam'],
