...
const checks = [
  ...
  [api.includes("cacheKey('ga4:commerce-losses:v10'"), 'commerce cache key invalidates rows without country-aligned test cohorts'],
  ...
  [ui.includes('PH ₱499 landing → cart') && ui.includes('phCartAdds / paidPhLandings'), 'dashboard renders Philippines price-test conversion'],
  [ui.includes('MY RM29.90 landing → cart') && ui.includes('myCartAdds / paidMyLandings'), 'dashboard renders Malaysia discount-test conversion'],
