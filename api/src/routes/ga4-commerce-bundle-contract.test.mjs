...
const checks = [
  ...
  [api.includes("'frontend_error_script_first_party'") && api.includes("'frontend_error_resource_third_party'") && api.includes("'frontend_error_promise_runtime'"), 'commerce and realtime reports retain classified frontend failures'],
