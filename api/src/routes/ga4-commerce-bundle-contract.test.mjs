...
const checks = [
  ...
  [api.includes("cacheKey('ga4:commerce-losses:v25'") && api.includes("host: 'com'"), 'commerce cache key exposes distinct-user and checkout-intent measurement immediately'],
