...
const checks = [
  ...
  [api.includes("const PRICE_TEST_COMPLETE_START_DATE = '2026-09-05'") && api.includes("const PRICE_TEST_COMPLETE_END_DATE = '2026-09-10'") && api.includes("suppressed_minute_policy: 'complete_property_dates_plus_exact_boundaries'") && api.includes('completeTestEventTotal(event, country, page) + boundaryEventTotal(event, country, page)'), 'privacy-suppressed rows use complete property dates plus only timestamped boundary events'],
