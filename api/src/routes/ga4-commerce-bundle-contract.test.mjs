...
const checks = [
  ...
  [api.includes("'ph_499_price_view'") && api.includes("'ph_499_add_to_cart'") && api.includes("'ph_499_cart_view'") && api.includes("'ph_499_checkout_click'") && api.includes("'my_2990_price_view'") && api.includes("'my_2990_add_to_cart'") && api.includes("'my_2990_cart_view'") && api.includes("'my_2990_checkout_click'"), 'API requests exact price-coded offer funnel events'],
  ...
  [types.includes('ph_exact_offer_views: number') && types.includes('ph_exact_offer_checkout_clicks: number') && types.includes('my_exact_offer_adds: number') && types.includes('my_exact_offer_cart_views: number'), 'shared response type exposes exact offer funnel instrumentation'],
  ...
  [ui.includes('PH exact-offer signal') && ui.includes('MY exact-offer signal') && ui.includes('PH exact cart → checkout') && ui.includes('MY exact cart → checkout') && ui.includes('Exact checkout boundary'), 'dashboard exposes date-suppression-safe offer funnels'],
