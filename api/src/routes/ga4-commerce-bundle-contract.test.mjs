...
const checks = [
  ...
  [api.includes("'ph_499_price_view'") && api.includes("'ph_499_add_to_cart'") && api.includes("'my_2990_price_view'") && api.includes("'my_2990_add_to_cart'"), 'API requests exact price-coded offer events'],
  ...
  [types.includes('ph_exact_offer_views: number') && types.includes('my_exact_offer_adds: number'), 'shared response type exposes exact offer instrumentation'],
  ...
  [ui.includes('PH exact-offer signal') && ui.includes('MY exact-offer signal') && ui.includes('Price-coded telemetry'), 'dashboard exposes date-suppression-safe offer cohorts'],
