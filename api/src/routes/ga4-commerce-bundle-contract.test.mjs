...
const checks = [
  ...
  [api.includes("cacheKey('ga4:commerce-losses:v32'") && api.includes("host: 'com'"), 'commerce cache key exposes article product measurement immediately'],
  ...
  [api.includes("'frontend_error_script_first_party'") && api.includes("'frontend_error_resource_third_party'") && api.includes("'frontend_error_image_first_party'") && api.includes("'frontend_error_style_third_party'") && api.includes("'frontend_error_font_first_party'") && api.includes("'frontend_error_media_first_party'") && api.includes("'frontend_error_promise_runtime'"), 'commerce and realtime reports retain classified frontend failures'],
