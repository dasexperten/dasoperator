...
const checks = [
  ...
  ['commerce attribution includes checkout progression', api.includes("'checkout_loaded'") && api.includes("'checkout_email_complete'") && api.includes("'checkout_address_started'") && api.includes("'checkout_address_complete'") && api.includes("'shipping_quote_ready'") && api.includes("'add_payment_info'")],
