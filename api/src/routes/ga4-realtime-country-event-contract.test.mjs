...
const checks = [
  ...
  ['API keeps checkout interaction stages', api.includes("'checkout_email_started'") && api.includes("'checkout_email_complete'") && api.includes("'checkout_address_started'")],
  ['API keeps bundle outcomes', api.includes("'shipping_bundle_offer'") && api.includes("'shipping_bundle_view'") && api.includes("'shipping_bundle_unavailable'") && api.includes("'shipping_bundle_add'")],
