...
const checks = [
  ['API requests country, event and minute dimensions together', /dimensions: \[\{ name: 'country' \}, \{ name: 'eventName' \}, \{ name: 'minutesAgo' \}\]/.test(api)],
  ...
  ['shared response type includes country-event freshness', types.includes('last_seen_minutes_ago: number')],
];
