// Ozon promo guard: elastic-stock guard + zero-bid restore for search-promo campaigns.
// Its own dry mode is the dry_run row in its config table (promozon database). Model-free.
// Copied from the LIVE Cloudflare worker promozon on 2026-09-18; the config and status
// routes stay on that worker.
