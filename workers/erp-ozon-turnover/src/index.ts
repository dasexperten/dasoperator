...
import { runOzonDayTurnover } from '../../_marketplace/seat-reports.mjs';
...
export default erpWorker<Env>('erp-ozon-turnover', async (env, dry, cron) => {
  ...
  const r = await runOzonDayTurnover(seat);
