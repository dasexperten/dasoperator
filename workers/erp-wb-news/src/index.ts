...
import { runWbNews } from '../../_marketplace/seat-reports.mjs';
...
export default erpWorker<Env>('erp-wb-news', async (env, dry, cron) => {
  ...
  const r = await runWbNews(seat, 1, { hour: cellHour(cron) });
