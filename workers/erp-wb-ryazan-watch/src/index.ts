...
import { runRyazanCheck } from '../../_marketplace/seat-reports.mjs';
...
export default erpWorker<Env>('erp-wb-ryazan-watch', async (env, dry, cron) => {
  ...
  const r = await runRyazanCheck(seat);
