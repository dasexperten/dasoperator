...
import { runWbDayTurnover } from '../../_marketplace/seat-reports.mjs';
...
export default erpWorker<Env>('erp-wb-turnover', async (env, dry, cron) => {
  ...
  const r = await runWbDayTurnover(seat);
